...
$('a:contains("click to download")').on('click', function () {
	var _ref = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(e) {
		var title, urls, requests, files, blob, url, a;
			...
			while (1) {
				switch (_context.prev = _context.next) {
					case 0:
						...
						urls = $('tr>td.clickable-row:not([align])').toArray().map(function (el) {
							return $(el).find('a').attr('href');
						});
						requests = urls.map(function (e) {
					...
					case 7:
						_context.t0 = function (html) {
							var url = $(html).find('a:contains("Click here to download as MP3")').attr('href');
						...
						return files.reduce(function (zip, file) {
							...
							return zip;
						}, new JSZip()).generateAsync({ type: 'blob' }, function (meta) {
